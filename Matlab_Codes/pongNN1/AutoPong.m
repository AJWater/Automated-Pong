...
MAX_BALL_SPEED = 3*speed_factor; %wont accelerate bast this, dont set too high or bugs.
...
while ~quitGame  
  ...
  paddle1V = predict(Theta1, Theta2, Theta3, X) -2;
  %paddle2V = predict(Theta4, Theta5, Theta6, X) -2;
  data_X = [data_X;X];
